...
![结构](/images/STM32开发环境配置/项目结构.png "结构")
...
![CMSIS](/images/STM32开发环境配置/CMSIS.png "CMSIS")

添加标准库文件进入LIB目录

![LIB](/images/STM32开发环境配置/SPL.png "LIB")
...
![方块](/images/STM32开发环境配置/方块.png "方块")

CMSIS需要添加目录下的所有.c文件以及.s文件

![CMSIS](/images/STM32开发环境配置/环境配置.png "CMSIS")
...
![inc](/images/STM32开发环境配置/inc.png "inc")

添加完毕后在同样的选项下找到Preprocessor Symbols，添加宏定义

**USE_STDPERIPH_DRIVER**

![宏定义](/images/STM32开发环境配置/宏定义.png "宏定义")
