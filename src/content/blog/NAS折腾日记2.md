...
![ani-rss MCP配置](/images/NAS折腾日记2/mcp配置方式.png)

通过这个方式在astrbot的设置里注册mcp服务

效果如下

![AstrBot测试效果](/images/NAS折腾日记2/astrbot测试图.png)

然后经过qbit的下载，以及ani-rss的管理分类和重命名，在Jellyfin的页面下，我们能看到刮削完成后的尼古喵喵

![Jellyfin刮削效果](/images/NAS折腾日记2/jellyfin效果图.webp)
